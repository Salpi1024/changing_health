      ...
      <div className="App">
        ...
        <div className="explanation">
          <p>
            ...
            Rome. There are seven basic symbols: I, V, X, L, C, D and M. The
            first usage of the symbols began showing up around 900 B.C.{" "}
          </p>
          <p>
            The numerals developed out of a need for a common method of
            counting, essential to communications and trade. Counting on one&apos;s
            fingers got out of hand, so to speak, when you reached 10. So, a
            counting system was devised based on a person&apos;s hand.
          </p>
          <p>
            Type a Roman number in the input to see it converted to different
            formats!
          </p>
        </div>
